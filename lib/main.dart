...
const String inAppResearchBrief = '''# Idle Game 调研与改进建议
...
class _ControlPanel extends StatelessWidget {
  ...
  Widget _buildSelected(BuildContext context) {
    return switch (selectedTab) {
      ...
      OfficeTab.brief => const _ResearchBriefPanel(),
    };
  }
}
...
class _ResearchBriefPanel extends StatelessWidget {
  const _ResearchBriefPanel();
  ...
  Widget build(BuildContext context) {
    return _InfoPanel(
      ...
      children: [
        const Text(
          'This panel embeds the full idle-game research brief directly in shared Flutter code so iOS and Android both ship the same design context.',
          style: TextStyle(fontSize: 12),
        ),
        const SizedBox(height: 12),
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(8),
            border: Border.all(color: const Color(0xff273d33), width: 1.2),
          ),
          child: const SingleChildScrollView(
            child: SelectableText(
              inAppResearchBrief,
              key: Key('research_brief_text'),
